...

{
  ...
  Url: "https://www.youtube.com/watch?v=-XhSKeeLuJU",
},

{
  ...
  UrlGit: "https://github.com/carlos060798/api-reac-js-Rick-Morty",
  Url: "https://youtu.be/1cmiT5fxnbc?si=Hl3XBNBvUcUAQ6F_",
},

{
  id: 3,
  ProjectName: "Clon de X",
  description:
    "proyecto de clon de las funciones basicas  de la red socIal X construido con React js , Node js , Bostrapt,Mongo db ",
  UrlGit: "https://github.com/carlos060798/api-reac-js-Rick-Morty",
  Url: "https://www.youtube.com/watch?v=j9HBG3sM95M&t=38s",
    ...
    <section className="w-full flex justify-center pt-10 mb-16 lg:mb-32 bg-customDarkBg2 relative">
      ...
      <div className="flex flex-col w-full lg:w-[1150px] justify-center">
        ...
        >
          ...
          <div className="custom-block-big-title text-center mb-16 px-8 sm:px-24 md:px-48">
            <h4>Proyectos Fullstack</h4>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-2 xl:grid-cols-3 gap-8 px-6 xl:px-0 items-center">
            {dataProjectFullStack.map((project) => (
              <div
                className="custom-border-gray-darker rounded-xl bg-customDarkBg3 flex flex-col px-6 py-4"
                key={project.id}
              >
